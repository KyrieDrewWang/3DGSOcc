...
CUDA_VISIBLE_DEVICES=2,0,1,3 torchrun --nproc_per_node=4 tools/train.py configs/renderocc/splattingocc-Nframe.py --launcher pytorch --work_dir splattingocc_workdir
