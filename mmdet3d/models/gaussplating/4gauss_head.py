...
class GausSplatingHead(nn.Module):
    def __init__(self,
        ...
        self.depth_loss = silog_loss() # l1_loss 
    ...
    def forward(self, voxel_feats, cameras, opacity, depth, **kwargs):
        ...
        for batch_id in range(voxel_feats.shape[0]):
            ...
            for c_id in range(view_points[0].shape[0]):
                ...
                # print("rendered_depth_feature", rendered_depth_feature)
                if not self.use_sam and not self.use_sam_mask:
                    ...
                    rendered_depth_feature = (rendered_depth_feature+1e-7)*self.radius
        ...
        # return {"render_depth_loss": loss_dep}
